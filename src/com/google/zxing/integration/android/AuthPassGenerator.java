 ...
 *
 */
public class AuthPassGenerator {
   ...
   */
  public AuthPassGenerator(Mac mac) {
   ...
   */
  public AuthPassGenerator(final Mac mac, int passCodeLength, int interval) {
    this(new Signer() {
  ...
  public AuthPassGenerator(Signer signer, int passCodeLength, int interval) {
    this.signer = signer;
